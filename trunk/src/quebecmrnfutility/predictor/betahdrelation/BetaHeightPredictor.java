...
//	private Map<BetaHdSpecies, Map<String, GaussianEstimate>> blupsLibraryPlotReferenceMap = new HashMap<BetaHdSpecies, Map<String, GaussianEstimate>>();
	...
	private final Map<BetaHdSpecies, BetaHeightInternalPredictor> internalPredictors;
	...
	public BetaHeightPredictor(boolean isParametersVariabilityEnabled, boolean isRandomEffectsVariabilityEnabled, boolean isResidualVariabilityEnabled) {
		...
		internalPredictors = new HashMap<BetaHdSpecies, BetaHeightInternalPredictor>();
		init();
	}
	...
	protected final void init() {
		try {
			for (BetaHdSpecies species : BetaHdSpecies.values()) {		
				BetaHeightInternalPredictor internalPredictor = new BetaHeightInternalPredictor(species, 

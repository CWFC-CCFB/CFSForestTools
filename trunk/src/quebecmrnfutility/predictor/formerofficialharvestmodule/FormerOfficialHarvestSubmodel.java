...
class FormerOfficialHarvestSubmodel extends ModelBasedSimulator {
	 ...
	 */
	protected FormerOfficialHarvestSubmodel(boolean isParameterVariabilityEnabled,
	 ...
	 */
	protected FormerOfficialHarvestSubmodel() {
		this(false, false);
	}

	protected void setDefaultBeta(Matrix beta, Matrix variance) {
		this.defaultBeta = new SASParameterEstimate(beta, variance);		
	}

...
public class OfficialHarvestTreatmentDefinitionV2 implements Serializable, 
															REpiceaMatchWithEnumObject<String, TreatmentType>,
	...
	private String vegPot;
	private TreatmentType treatmentType;
	private int delayBeforeNextTreatmentYrs;
	
	public OfficialHarvestTreatmentDefinitionV2(String vegPot, TreatmentType treatmentType) {
		this.vegPot = vegPot;
		this.treatmentType = treatmentType;
	}

	OfficialHarvestTreatmentDefinitionV2(String vegPot, TreatmentType treatmentType, int delayBeforeNextTreatmentYrs) {
		this(vegPot, treatmentType);
		this.delayBeforeNextTreatmentYrs = delayBeforeNextTreatmentYrs;
	}
	
//	protected static OfficialHarvestTreatmentDefinitionV2[] getDefinitionOfAllAvailableTreatment() {
//		List<OfficialHarvestTreatmentDefinitionV2> definitions = new ArrayList<OfficialHarvestTreatmentDefinitionV2>();
//		for (TreatmentType t : TreatmentType.values()) {
//			definitions.add(new OfficialHarvestTreatmentDefinitionV2(t));
//		}
//		return definitions.toArray(new OfficialHarvestTreatmentDefinitionV2[]{});
//	}
	...
	@Override
	public OfficialHarvestTreatmentDefinitionV2 getDeepClone() {
		OfficialHarvestTreatmentDefinitionV2 copy = new OfficialHarvestTreatmentDefinitionV2(vegPot, treatmentType, delayBeforeNextTreatmentYrs);
		return copy;
	}
	...
	@Override
	public void setValue(TreatmentType value) {this.treatmentType = value;}

	@Override
	public String getKey() {return vegPot;}

	
	public boolean equals(Object o) {
		if (o != null || o instanceof OfficialHarvestTreatmentDefinitionV2) {
			OfficialHarvestTreatmentDefinitionV2 def = (OfficialHarvestTreatmentDefinitionV2) o;
			if (treatmentType == def.treatmentType) {
				if (vegPot.equals(def.vegPot)) {
					if (delayBeforeNextTreatmentYrs == def.delayBeforeNextTreatmentYrs) {
						return true;
					}
				}
			}
